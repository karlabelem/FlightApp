...
CREATE TABLE Users_belem(username VARCHAR(20) PRIMARY KEY,
                           hashedPassword VARBINARY(256) NOT NULL,
                   balance INT NOT NULL);

CREATE TABLE Reservations_belem(res_id INT PRIMARY KEY,
                                  paid INT NOT NULL,
                                  username VARCHAR(20) NOT NULL REFERENCES Users_belem(username),
